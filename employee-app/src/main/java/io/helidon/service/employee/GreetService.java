 ...
 *
 * Change greeting
 * curl -X PUT -H "Content-Type: application/json" -d '{"greeting" : "Howdy"}' http://localhost:8060/greet/greeting
 *
 * The message is returned as a JSON object
 */

public class GreetService {
    // Commenting to continue with employee API & also removed implements Service
